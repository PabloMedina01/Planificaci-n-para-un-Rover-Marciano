...
(define (problem rovers_parte_2_1)
    ...
    (:init
        ...
        ;; Se anade visibilidad bidireccional entre waypoint4 y sus vecinos
        ...
        ;; Se anaden muestras de suelo y roca que el rover debe recolectar
        ...
        ;; Bateria de rover0 con nivel inicial b4
    ...
    (:goal
        (and
            ...
            ;; CAMBIO 1.5: Objetivo de posicion final
            ;; El rover debe terminar en waypoint1 despues de completar todas las tareas
            (at rover0 waypoint1)
        )
    )
)