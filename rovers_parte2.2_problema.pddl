...
(define (problem rovers_parte2_2)
    ...
    (:init
        ...
        ;; CAMBIO 2.1: Adicion de rover1
        ;; rover1 es un segundo rover con capacidades de movimiento, analisis de suelo/roca e imaging
        ;; Posicion inicial: waypoint0 (diferente a rover0 que inicia en waypoint3)
        ...
        ;; Se definen rutas diferentes a rover0 para optimizar la exploracion
        ...
        ;; CAMBIO 2.3: Camera y bateria para rover1
        ;; camera1 calibrada con objective0 (rover0 usa camera0 con objective1)
        (on_board camera1 rover1)
        (calibration_target camera1 objective0)
        (supports camera1 colour)
        (supports camera1 high_res)
        ;; Bateria de rover1 tambien con nivel inicial b4
        (battery_installed rover1 bat1 b4 b4)

        ;; Definicion del orden parcial de niveles de bateria
        ;; (usado por la accion navigate-bat para consumir energia)
        (lower b0 b1)
        (lower b1 b2)
        (lower b2 b3)
        (lower b3 b4)
